...
public class CronometroWidget extends AppWidgetProvider {
	...
	public void onUpdate(Context context, AppWidgetManager appWidgetManager,
		...
		RemoteViews rv = new RemoteViews(context.getPackageName(), R.layout.cronometro_widget);
		
		rv.setChronometer(R.id.chronoWidget, tempoChrono, null, chronoIniciado);
		
		
		ComponentName cn = new ComponentName(context, CronometroWidget.class);
